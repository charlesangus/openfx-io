...
struct alias_cast_float {
    alias_cast_float()
        : raw(0) {}; // initialize to 0 in case sizeof(T) < 8
...
#endif
        (ocioColorspace == "Linear") || (ocioColorspace == "linear") || (ocioColorspace == "ACES2065-1") || (ocioColorspace == "aces") || (ocioColorspace == "lnf") || (ocioColorspace == "ln16")) {
